...
import { onCreateAchievementAdminAction } from "stores/modules/admin";
...
function CreateAchievement() {
    ...
    const onCreate = () => {
        ...
        dispatch(onCreateAchievementAdminAction({
            link,
            title,
            image: avatar
        }, onSuccess));
    ...
    return (
        <AdminContainer>
            <AdminLayout>
                <AdminNavbar header={i18n.t('them_thanh_tuu_moi')} />
                <>
                                ...
                                <Card sx={{px: 2, pb: 3}}>
                                    ...
                                    <MKBox px={1}>
                                        <MKInput
                                            ...
                                            chinh_sua_thanh_tuu             InputLabelProps={{ shrink: true }}
                                            fullWidth
                                            sx={{mb: 4}}
                                            multiline
                                            rows={2}
