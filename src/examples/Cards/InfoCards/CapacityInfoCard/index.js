...
function CapacityInfoCard({ variant, color, icon, title, description, action }) {
  const buttonStyles = {
    width: "max-content",
    display: "flex",
    alignItems: "center",
...
CapacityInfoCard.defaultProps = {
  variant: "contained",
  color: "info",
  action: false,
};

CapacityInfoCard.propTypes = {
...
export default CapacityInfoCard;
